    ...
    <header className="dmd-navbar">
      <div className="dmd-navbar-left">
        ...
        <a href="#/README" className="dmd-brand">
          {config.theme?.logo?.light && (
            <img
              src={resolvedMode === 'dark' && config.theme?.logo?.dark ? config.theme.logo.dark : config.theme.logo.light}
      ...
      <div className="dmd-navbar-center">
        {config.search?.enabled !== false && (
          <button className="dmd-search-trigger" onClick={() => setIsSearchOpen(true)}>
